...
CREATE VIEW tickets AS
	select r.reimb_id, r.reimb_amount, r.reimb_submitted, r.reimb_resolved, r.reimb_description, r.reimb_receipt, ur.first_name, ur.last_name, ur.user_email,  r.reimb_resolver, rt.reimb_type, rs.reimb_status 
	from reimbursements r 
	inner join users ur 
	on r.reimb_author = ur.user_id 
	inner join reimbursement_type rt 
